...
loader.load('/minigame1/map.glb', (gltf) => {
...
loadSharkModel(loader).then(() => {
    ...
    // Load đá
    loader.load('/minigame1/Rocks.glb', (gltf) => {
        gltf.scene.traverse((child) => {
...
// Load rong biển
loader.load('/minigame1/Seaweed.glb', (gltf) => {
